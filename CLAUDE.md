...
### Next.js Application
- **`/app`** — Next.js 14 App Router (landing page + digital menu + ordering + staff dashboard)
- **`/lib`** — Shared TypeScript libraries (menu-data.ts, orders-store.ts)
- **`/public/assets`** — Optimized images (JPG only, ~1MB)

### Content Engine
- **`/content-engine`** — Python scripts for AI image/video generation
- Google Gemini API (Imagen 4 Fast + Veo 3.1)
- Automated poster generation for social media

### File Organization
- **`/Photos_from_bar`** — Original bar photography с AI-enhanced качество (20 PNG with descriptive names)
- **`/generated-posters`** — AI-generated marketing materials
- **`/archive-2026-03`** — Historical files (old website, workflow versions)
- **`/.planning`** — Project management (DO NOT MODIFY)

### Маркетинг Assets
- All bar photos upgraded to AI-enhanced PNG format (superior quality)
- Descriptive filenames for easy identification
- AI-generated posters in `/generated-posters`
