...
export const MENU: Menu = {
    ...
    wine: {
        ...
        items: [
            // ── Бяло вино ──
            { id: 'wine-white-180', name: 'Бяло вино — чаша 180 мл', price: 3, desc: 'Verano Azur', image: '/menu-images/wine-white-180.png' },
            { id: 'wine-white-375', name: 'Бяло вино — 375 мл', price: 9, desc: 'Verano Azur', image: '/menu-images/wine-white-180.png' },
            { id: 'wine-white-750', name: 'Бяло вино — 750 мл', price: 16, desc: 'Verano Azur', image: '/menu-images/wine-white-180.png' },
            // ── Червено вино ──
            { id: 'wine-red-180', name: 'Червено вино — чаша 180 мл', price: 3, desc: 'Verano Azur', image: '/menu-images/wine-red-180.png' },
            { id: 'wine-red-375', name: 'Червено вино — 375 мл', price: 9, desc: 'Verano Azur', image: '/menu-images/wine-red-180.png' },
            { id: 'wine-red-750', name: 'Червено вино — 750 мл', price: 16, desc: 'Verano Azur', image: '/menu-images/wine-red-180.png' },
            // ── Розе ──
            { id: 'wine-rose-180', name: 'Розе — чаша 180 мл', price: 3, desc: 'Verano Azur', image: '/menu-images/wine-rose-180.png' },
            { id: 'wine-rose-375', name: 'Розе — 375 мл', price: 9, desc: 'Verano Azur', image: '/menu-images/wine-rose-180.png' },
            { id: 'wine-rose-750', name: 'Розе — 750 мл', price: 16, desc: 'Verano Azur', image: '/menu-images/wine-rose-180.png' },
            // ── Шампанско ──
            { id: 'wine-moet', name: 'Moët Chandon', price: 245, desc: 'Шампанско', tags: ['Premium'], image: '/menu-images/wine-moet.png' },
            { id: 'wine-prosecco', name: 'Prosecco', price: 35, desc: 'Шампанско', image: '/menu-images/wine-prosecco.png' },
        ],
    },
    ...
    whiskey: {
        ...
        items: [
            ...
            { id: 'wh-jb', name: 'J&B', price: 5, desc: 'Уиски 50 мл', image: '/menu-images/wh-jb.png' },
            { id: 'wh-bushmills', name: 'Bushmills', price: 5, desc: 'Уиски 50 мл', image: '/menu-images/wh-bushmills.png' },
            { id: 'wh-jameson', name: 'Jameson', price: 5, desc: 'Уиски 50 мл', image: '/menu-images/spirit-jameson.png' },
            { id: 'wh-black-bush', name: 'Black Bush', price: 6, desc: 'Уиски 50 мл', image: '/menu-images/wh-black-bush.png' },
            ...
            { id: 'wh-jw-green', name: 'Johnnie Walker Green Label', price: 17, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-jw-green.png' },
            { id: 'wh-jw-gold', name: 'Johnnie Walker Gold Label', price: 17, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-jw-gold.png' },
            ...
            { id: 'wh-jd-barrel', name: 'Jack Daniel\'s Single Barrel', price: 15, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-jd-barrel.png' },
            ...
            { id: 'wh-glen-15', name: 'Glenfiddich 15 y.o.', price: 15, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-glen-15.png' },
    ...
    bourbon: {
        ...
        items: [
            ...
            { id: 'wh-four-roses', name: 'Four Roses', price: 4, desc: 'Бърбън 50 мл', image: '/menu-images/bourbon-four-roses.png' },
            { id: 'wh-wild-turkey', name: 'Wild Turkey', price: 6, desc: 'Бърбън 50 мл', image: '/menu-images/bourbon-wild-turkey.png' },
        ],
    },
    ...
    vodka: {
        ...
        items: [
            ...
            { id: 'sp-vodka-finlandia', name: 'Finlandia', price: 4, desc: 'Водка 50 мл', image: '/menu-images/vodka-finlandia.png' },
    ...
    gin: {
        ...
        items: [
            ...
            { id: 'sp-gin-beefeater', name: 'Beefeater', price: 4, desc: 'Джин 50 мл', image: '/menu-images/gin-beefeater.png' },
    ...
    rum: {
        ...
        items: [
            ...
            { id: 'sp-rum-captain-gold', name: 'Captain Morgan Gold', price: 5, desc: 'Ром 50 мл', image: '/menu-images/rum-captain-gold.png' },
            { id: 'sp-rum-havana', name: 'Havana Club', price: 4, desc: 'Ром 50 мл', image: '/menu-images/spirit-havana-club.png' },
            { id: 'sp-rum-havana7', name: 'Havana Club 7 y.o.', price: 7, desc: 'Ром 50 мл', tags: ['Aged'], image: '/menu-images/rum-havana7.png' },
            { id: 'sp-rum-malibu', name: 'Malibu', price: 4, desc: 'Ром 50 мл', image: '/menu-images/rum-malibu.png' },
        ],
    },
    ...
    tequila: {
        ...
        items: [
            ...
            { id: 'sp-teq-cuervo-silver', name: 'Jose Cuervo Silver', price: 2.5, desc: 'Текила 30 мл', image: '/menu-images/tequila-cuervo-silver.png' },
            { id: 'sp-teq-cuervo-repo', name: 'Jose Cuervo Reposado', price: 2.5, desc: 'Текила 30 мл', image: '/menu-images/tequila-cuervo-repo.png' },
        ],
    },
    ...
    brandy: {
        ...
        items: [
            ...
            { id: 'sp-brandy-metaxa', name: 'Metaxa', price: 4, desc: 'Бренди 50 мл', image: '/menu-images/brandy-metaxa.png' },
            { id: 'sp-brandy-courvoisier', name: 'Courvoisier', price: 7, desc: 'Бренди 50 мл', tags: ['Premium'], image: '/menu-images/brandy-courvoisier.png' },
        ],
    },
    ...
    liqueurs: {
        ...
        items: [
            ...
            { id: 'sp-liq-kahlua', name: 'Kahlúa', price: 5, desc: 'Ликьор 50 мл (цената не е посочена в менюто)', tags: ['Цена ориентировъчна'], image: '/menu-images/liqueur-kahlua.png' },
            ...
            { id: 'sp-liq-cointreau', name: 'Cointreau', price: 5, desc: 'Ликьор 50 мл', image: '/menu-images/liqueur-cointreau.png' },
            { id: 'sp-liq-disaronno', name: 'Disaronno', price: 5, desc: 'Ликьор 50 мл', image: '/menu-images/liqueur-disaronno.png' },
    ...
    digestifs: {
        ...
        items: [
            ...
            { id: 'sp-dig-absinthe', name: 'Absinthe', price: 5, desc: 'Дижестив 50 мл', image: '/menu-images/digestif-absinthe.png' },
            ...
            { id: 'sp-dig-aperol', name: 'Aperol', price: 4, desc: 'Дижестив 50 мл', image: '/menu-images/digestif-aperol.png' },
            { id: 'sp-dig-campari', name: 'Campari', price: 4, desc: 'Дижестив 50 мл', image: '/menu-images/digestif-campari.png' },
            { id: 'sp-dig-martini', name: 'Martini', price: 4, desc: 'Дижестив 50 мл', image: '/menu-images/digestif-martini.png' },
            ...
            { id: 'sp-dig-fernet', name: 'Fernet-Branca', price: 4, desc: 'Дижестив 50/30 мл — 4/2 €', volume: '50/30 мл', image: '/menu-images/digestif-fernet.png' },
    ...
    beer: {
        ...
        items: [
            ...
            // ── Бутилка 330 мл ──
            { id: 'beer-estrella', name: 'Estrella Damm', price: 4, desc: 'Бутилка 330 мл', image: '/menu-images/beer-estrella.png' },
            ...
            { id: 'beer-bernard', name: 'Bernard Blond', price: 4.5, desc: 'Бутилка 330 мл', image: '/menu-images/beer-bernard.png' },
