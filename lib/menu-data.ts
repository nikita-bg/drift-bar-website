...
export const MENU: Menu = {
    ...
    spirits: {
        ...
        items: [
            ...
            { id: 'sp-liq-kahlua', name: 'Kahlúa', price: 5, desc: 'Ликьор 50 мл' },
            { id: 'sp-liq-galliano', name: 'Galliano', price: 5, desc: 'Ликьор 50/30 мл — 5/3 €', volume: '50/30 мл' },
            ...
            { id: 'sp-dig-sambuca', name: 'Sambuca', price: 4, desc: 'Дижестив 50/30 мл — 4/2 €', volume: '50/30 мл' },
    ...
    food: {
        ...
        items: [
            ...
            { id: 'food-fruit-plate', name: 'Плодове сезонни за двама', price: 10, desc: '500 г' },
    ...
    soft: {
        ...
        items: [
            ...
            { id: 'soft-perrier', name: 'Perrier 330 мл', price: 3, desc: '' },
