...
export const MENU: Menu = {
    ...
    whiskey: {
        ...
        items: [
            // ── Уиски ──
            { id: 'wh-jw-red', name: 'Johnnie Walker Red Label', price: 5, desc: 'Уиски 50 мл', image: '/menu-images/wh-jw-red.svg' },
            ...
            { id: 'wh-jameson', name: 'Jameson', price: 5, desc: 'Уиски 50 мл', image: '/menu-images/wh-jameson.svg' },
            { id: 'wh-black-bush', name: 'Black Bush', price: 6, desc: 'Уиски 50 мл', image: '/menu-images/wh-black-bush.svg' },
            { id: 'wh-monkey-shoulder', name: 'Monkey Shoulder', price: 7, desc: 'Уиски 50 мл', image: '/menu-images/wh-monkey-shoulder.svg' },
            { id: 'wh-jack-daniels', name: 'Jack Daniel\'s', price: 7, desc: 'Уиски 50 мл', image: '/menu-images/wh-jack-daniels.svg' },
            // ── Отлежало уиски ──
            { id: 'wh-jw-black', name: 'Johnnie Walker Black Label', price: 8, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-jw-black.svg' },
            ...
            { id: 'wh-chivas-12', name: 'Chivas Regal 12 y.o.', price: 8, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-chivas-12.svg' },
            ...
            { id: 'wh-glen-12', name: 'Glenfiddich 12 y.o.', price: 8, desc: 'Отлежало уиски 50 мл', tags: ['Aged'], image: '/menu-images/wh-glen-12.svg' },
    ...
    bourbon: {
        ...
        type: 'simple',
        items: [
            { id: 'wh-jim-beam', name: 'Jim Beam', price: 4, desc: 'Бърбън 50 мл', image: '/menu-images/bourbon-jim-beam.svg' },
            { id: 'wh-makers-mark', name: 'Maker\'s Mark', price: 5.5, desc: 'Бърбън 50 мл', image: '/menu-images/bourbon-makers-mark.svg' },
    ...
    vodka: {
        ...
        items: [
            ...
            { id: 'sp-vodka-smirnoff', name: 'Smirnoff', price: 4, desc: 'Водка 50 мл', image: '/menu-images/vodka-smirnoff.svg' },
            { id: 'sp-vodka-absolut', name: 'Absolut', price: 4, desc: 'Водка 50 мл', image: '/menu-images/vodka-absolut.svg' },
    ...
    gin: {
        ...
        items: [
            ...
            { id: 'sp-gin-gordons', name: 'Gordon\'s', price: 4, desc: 'Джин 50 мл', image: '/menu-images/gin-gordons.svg' },
            { id: 'sp-gin-beefeater', name: 'Beefeater', price: 4, desc: 'Джин 50 мл', image: '/menu-images/gin-beefeater.svg' },
            { id: 'sp-gin-bombay', name: 'Bombay Sapphire', price: 5.5, desc: 'Джин 50 мл', image: '/menu-images/gin-bombay.svg' },
    ...
    rum: {
        ...
        items: [
            ...
            { id: 'sp-rum-captain', name: 'Captain Morgan', price: 5, desc: 'Ром 50 мл', image: '/menu-images/rum-captain.svg' },
            { id: 'sp-rum-captain-gold', name: 'Captain Morgan Gold', price: 5, desc: 'Ром 50 мл', image: '/menu-images/rum-captain-gold.svg' },
            { id: 'sp-rum-havana', name: 'Havana Club', price: 4, desc: 'Ром 50 мл', image: '/menu-images/rum-havana.svg' },
    ...
    liqueurs: {
        ...
        type: 'simple',
        items: [
            { id: 'sp-liq-baileys', name: 'Bailey\'s', price: 5, desc: 'Ликьор 50 мл', image: '/menu-images/liqueur-baileys.svg' },
    ...
    digestifs: {
        ...
        items: [
            ...
            { id: 'sp-dig-jagermeister', name: 'Jägermeister', price: 4, desc: 'Дижестив 50/30 мл — 4/2 €', volume: '50/30 мл', image: '/menu-images/digestif-jagermeister.svg' },
