...
export const EVENTS: Event[] = [
    {
        id: 'e22',
        title: 'Dimitar Liolev Quintet',
        genre: 'Джаз',
        date: '2026-05-30',
        dayName: 'Събота',
        time: '21:00',
        price: 10,
        description: 'Джаз вечер от висока класа в Drift — саксофонистът Димитър Льолев и неговият квинтет (Иван Мелин – тромбон, Николай Карагеоргиев – китара, Александър Леков – бас, Александър Каменов – барабани) поднасят топъл, изискан жив джаз. Врата 20:00, начало 21:00.',
        tags: ['LIVE', 'JAZZ'],
        color: '#2c3e6b',
        month: 'МАЙ',
        image: '/events/dimitar-liolev-quintet.jpg',
    },
    {
        id: 'e20',
        title: 'АКУСТИК',
        ...
        time: '20:30',
        price: 5,
        description: 'Елегантна акустична вечер в Drift с триото „Акустик" — Кръстьо Пънев (китара), Йордан Маринов (китара) и Николай Балинов (бас). Изтънчен микс от латино, джаз и блус — перфектната компания за чаша хубаво вино. Врата 20:00, начало 20:30.',
        tags: ['LIVE', 'ACOUSTIC'],
        color: '#c0873a',
        month: 'МАЙ',
    ...
    },
    {
        ...
        time: '22:00',
        price: 5,
        description: 'DJ Borrix отново зад пулта в Drift Bar — open-format нощ с mashup-и, ремикси и оригинални миксове до сутринта. Врата 21:00, начало 22:00.',
        tags: ['DJ', 'PARTY'],
        color: '#e67e22',
        month: 'МАЙ',
        image: '/events/dj-borrix-23-05.png',
    },
    {
        id: 'e15',
