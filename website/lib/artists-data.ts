...
export const ARTISTS: readonly Artist[] = [
    ...
    },
    {
        ...
        imageUrl: '/events/sharp-dressed-men.jpg',
    ...
    },
    {
        ...
        imageUrl: '/events/6-decades-music.png',
    ...
    },
    {
        ...
        name: 'DJAANY',
        genre: 'DJ Set',
        bio: 'DJAANY е един от най-разпознаваемите DJ-и в българската клубна сцена — open-format сетове с house, urban и club classics. На сцената на Drift Bar Plovdiv с support от ZED. Енергия и парти до сутринта.',
        imageUrl: '/events/djaany.png',
    ...
    },
    {
        ...
        name: 'ORIMBE',
        genre: 'Джаз & Латино',
        bio: 'ORIMBE е специален състав, който смесва Live Jazz, Fusion и Afrobeat в една вечер. Топъл духов саунд (тромпет, саксофон), грууви ритъм секция и неочаквани композиционни обрати — идеално за интимната акустика на Drift Bar.',
        imageUrl: '/events/orimbe.jpg',
    ...
    },
    {
        ...
        name: 'DJ JMJ',
        genre: 'DJ Set',
        bio: 'DJ JMJ носи на дансинга на Drift Bar истинска Retro Night — funk, soul и класики, които задават настроението. Майстор на open-format-а с дълъг стаж в българската нощна сцена.',
        imageUrl: '/events/dj-jmj.jpg',
