                        ...
                        <div className={styles.aboutGrid}>
                            ...
                            <div className={`${styles.aboutText} ${styles.reveal}`}>
                                ...
                                <p className={styles.aboutDescription}>
                                    Drift Bar е най-новото място за жива музика в центъра на Пловдив. С професионално звуково и светлинно оборудване, ние създадохме пространство, където музикантите се чувстват като у дома си, а публиката — като на най-добрия концерт.
                                </p>
                                <p className={styles.aboutDescription}>
                                    Нашата концепция е проста: качествена жива музика, авторски коктейли и автентична атмосфера. От рок и хард рок до блус и джаз — тук звучи всичко, което идва от сърцето.
                                </p>
